...
收起态只显示高、中、低优先级数量；悬停后展开为更大的任务岛，显示当前任务、快速新增、完成和固定。

### 任务面板

![任务面板](assets/screenshots/02-task-panel.png)

点击悬浮岛后进入完整任务面板。默认显示所有未完成任务，并保留当前任务、任务列表、视图切换和面板固定能力。
...
单条任务支持备注、截止时间、提醒时间、重复规则、项目、标签、子任务和单独的专注分钟。
...
设置里可以控制显示悬浮岛、菜单栏标题、暗夜模式、顶部间距、透明度、背景颜色和文字颜色。

### 设置：专注与优先级

![专注与优先级设置](assets/screenshots/07-settings-focus-priority.png)

支持默认专注时长、快捷时长按钮，以及高、中、低优先级颜色自定义。
